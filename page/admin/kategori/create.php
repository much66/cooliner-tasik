            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="au-card-title" style="background-image:url('images/bg8.png');">
                            ...
                            <h3>
                            <i class="zmdi zmdi-widgets"></i>Data Kategori</h3>
                        </div>
                        <form method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="hidden" style="font-weight: bold; color: red;" class="form-control" name="kd_kategori" value="<?php echo $autokode; ?>" readonly>
                                    </div>
                                    <div class="form-group">
