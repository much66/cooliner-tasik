<?php 
    ...
    $kt = new Resto();
    $table = "tb_kategori";
    $data = $kt->selectWhere($table, "kd_kategori", $_GET['kd'])[0];
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="card-body">
                                    ...
                                    <input type="hidden" style="font-weight: bold; color: red;" class="form-control" name="kd_kategori" value="<?php echo $data['kd_kategori']; ?>" readonly>
                                </div>
                                <div class="form-group">
