    ...
    if (isset($_POST['getUbah'])) {
        ...
        if($kd_user == "" || $name == "" || $email == "" || $username == "" || $password == "" || $level == ""){
            ...
            if($_FILES['avatar']['name'] == ""){
                ...
                $response = $kt->update($table, $value, "kd_user", $data['kd_user'], "?page=indexLevel");
            }else{
            ...
            <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="au-card-title" style="background-image:url('images/bg.jpg');">
                            ...
                            <h3>
                            <i class="zmdi zmdi-account-calendar"></i>Edit Data Anda</h3>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="file" name="avatar" id="photo" data-allowed-file-extensions="png jpg jpeg" class="dropify" data-default-file="images/<?= $data['avatar'] ?>">
                                 </div>
