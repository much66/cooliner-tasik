<?php 
    ...
    $kt = new Resto();
    $table = "tb_user";
    $data = $kt->selectWhere($table, "kd_user", $_GET['id'])[0];
    ...
    if (isset($_POST['getUbah'])) {
        ...
        $avatar = $kt->validateHtml($_POST['avatar']);
                ...
                <div class="col-md-12">
                    <div class="au-breadcrumb-content">
                       <div class="au-breadcrumb-left">
                        ...
                        <a href="?page=indexLevel" class="btn btn-danger btn-sm float-right">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="au-card-title" style="background-image:url('images/bg8.png');">
                            ...
                            <h3>
                            <i class="zmdi zmdi-account-calendar"></i>Edit Data User</h3>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="file" name="avatar" id="photo" data-allowed-file-extensions="png jpg jpeg" class="dropify" data-default-file="img/<?= $data['avatar'] ?>">
                                 </div>
