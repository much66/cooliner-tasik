<?php
    $kt    = new Resto();
    $table = "tb_menu";
    $data        = $kt->selectWhere($table, "kd_menu", $_GET['kd'])[0];
    ...
    $response = $kt->update($table, $value, "kd_menu", $_GET['kd'], "?page=indexKuliner");
    } else {
                    ...
                    <div class="au-breadcrumb-content">
                        <div class="au-breadcrumb-left">
                            <ul class="list-unstyled list-inline au-breadcrumb__list">
                                ...
                                <li class="list-inline-item"><a href="?page=createKategori">Edit Kuliner</a></li>
                            </ul>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="au-card-title" style="background-image:url('images/bg8.png');">
                            ...
                            <h3>
                            <i class="zmdi zmdi-account-calendar"></i>Input Kuliner</h3>
                        </div>
                        <form method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="card-body">
                                    <div class="form-group">
                                        <input type="hidden" style="font-weight: bold; color: red;" class="form-control" name="kd_menu" value="<?=$data['kd_menu']?>" readonly>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="card-footer">
                                    <div class="float-right" style="margin-bottom: 15px;">
                                        <button name="getUbah" class="btn btn-warning"><i class="fa fa-edit"></i> Ubah</button>
                                    </div>
                                </form>
                            </div>
                        </div>
