        ...
        <div class="card mb-4" style="max-width: 1200px;">
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    ...
                    </p>                     <p class="card-text"><small class="text-muted">Last updated <?=$data['modify'];?></small></p>
                     </div>
                </div>
            </div>
        </div>
    		...
    		<div class="card-body">
    			<div class="row">
    				...
    				<div class="col-sm-4 text-center">
    					...
    					<a href="login.php"><Button type="button" class="btn btn-outline-warning">Beri Ulasan</button></a>
    				</div>
    			</div>
    		</div>
    	</div>
